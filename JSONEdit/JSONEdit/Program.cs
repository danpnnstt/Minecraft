	...
	public sealed class Program
	{
		...
		public static void Main(string[] args)
		{
			...
			//Application.Run(new MainForm());
                  ...
                  Console.Error.WriteLine("Working path: " + MainForm.BASE_DIRECTORY);
                  Console.Error.WriteLine("Creating form object.............");
                  MainForm mf = new MainForm();
                  Console.Error.WriteLine("Form object created.  Launching application....");
                  mf.ShowDialog();
		}
